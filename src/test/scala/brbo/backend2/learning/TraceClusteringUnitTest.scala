...
import brbo.backend2.learning.TraceClustering.BagOfWords
...
class TraceClusteringUnitTest extends AnyFlatSpec {
  "Computing the distances between traces" should "be correct" in {
    TraceClusteringUnitTest.distanceMatrixTests.foreach({
      testCase =>
        val matrix = TraceClustering.distanceMatrix(traces = testCase.input.asInstanceOf[List[Interpreter.CostTrace]], BagOfWords)
...
object TraceClusteringUnitTest {
  ...
  val distanceMatrixTests: List[TestCase] = List(
    TestCase("traces1", traceList1, """List(List(100, 100), List(100, 100))"""),
    TestCase("traces2", traceList2, """List(List(100, 50), List(50, 100))"""),
    TestCase("traces3", traceList3, """List(List(100, 40), List(40, 100))"""),
    TestCase("traces4", traceList4, """List(List(100, 33), List(33, 100))"""),
    TestCase("traces5", traceList5, """List(List(100, 50), List(50, 100))"""),
    TestCase("traces6", traceList6, """List(List(100, 40), List(40, 100))"""),
    TestCase("traces7", traceList7, """List(List(100, 33), List(33, 100))"""),
    TestCase("traces8", traceList8, """List(List(100, 75), List(75, 100))"""),
    TestCase("traces9", traceList9, """List(List(100, 33), List(33, 100))"""),
    TestCase("traces10", traceList10, """List(List(100, 25), List(25, 100))"""),
    TestCase("traces11", traceList11, """List(List(100, 100), List(100, 100))"""),
  )
