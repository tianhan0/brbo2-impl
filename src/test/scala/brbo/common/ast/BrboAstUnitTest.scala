  ...
  val printToBrboJavaTests: List[TestCase] = List(
    TestCase("printToBrboJavaTest1", printToBrboJavaTest1,
      s"""abstract class Test {
         ...
         |    lessPreciseBound((((((0 + (D1 + (D1p * (C1 - 1)))) + (D2 + (D2p * (C2 - 1)))) + (D3 + (D3p * (C3 - 1)))) + (D4 + (D4p * (C4 - 1)))) + array) < 10);
         |    mostPreciseBound(!(((((((0 + (D1 + (D1p * (C1 - 1)))) + (D2 + (D2p * (C2 - 1)))) + (D3 + (D3p * (C3 - 1)))) + (D4 + (D4p * (C4 - 1)))) + array) < 10)) && !(((((((0 + (D1 + (D1p * (C1 - 1)))) + (D2 + (D2p * (C2 - 1)))) + (D3 + (D3p * (C3 - 1)))) + (D4 + (D4p * (C4 - 1)))) + array) == 10)));
         |    if (!((x < 10)) && !((x == 10)))
         |    {
         |      D1 = D1 + 10;
         |    }
